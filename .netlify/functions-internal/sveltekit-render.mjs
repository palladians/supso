	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/events/_eventId_/_server.ts.js'))
			},
			{
				id: "/api/signout",
				pattern: /^\/api\/signout\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/signout/_server.ts.js'))
			},
			{
				id: "/api/[...slugs]",
				pattern: /^\/api(?:\/(.*))?\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/_...slugs_/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/verify/_server.ts.js'))
			}
		],
		matchers: async () => {
