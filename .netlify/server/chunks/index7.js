import { s as setContext, b as getContext, c as create_ssr_component, a as subscribe, d as compute_rest_props, f as spread, i as escape_object, j as add_attribute, v as validate_component, h as escape_attribute_value } from "./ssr.js";
import "dequal";
import "./index5.js";
import { i as is_void, c as cn, f as flyAndScale } from "./utils.js";
import { a as createBitAttrs, d as createDispatcher } from "./events.js";
import { f as fade } from "./index9.js";
import { X as XIcon } from "./x.js";
import { d as derived } from "./index2.js";
import { c as createDialog } from "./create2.js";
import { r as removeUndefined, g as getOptionUpdater } from "./updater.js";
import "clsx";
        ...
        {},
        {
          default: () => {
            return `${slots.default ? slots.default({}) : ``} ${validate_component(Dialog_close, "DialogPrimitive.Close").$$render(
              ...
              {
                default: () => {
                  return `${validate_component(XIcon, "X").$$render($$result, { class: "h-4 w-4" }, {}, {})} <span class="sr-only" data-svelte-h="svelte-1pewzs3">Close</span>`;
                }
              }
            )}`;
          }
