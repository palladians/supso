      ...
      return `${validate_component(Card_header, "Card.Header").$$render($$result, {}, {}, {
        default: () => {
          return `<div class="flex items-center gap-4">${validate_component(Button, "Button").$$render(
            $$result,
            {
              href: `/projects/${$currentProjectId}/boards`,
              variant: "secondary",
              size: "icon"
            },
            {},
        ...
        default: () => {
          return `<form method="POST" class="flex flex-col gap-4"><fieldset class="flex flex-col gap-2">${validate_component(Label, "Label").$$render($$result, { for: "boardName" }, {}, {
            default: () => {
              return `Board Name`;
            }
          ...
          })} ${validate_component(Input, "Input").$$render($$result, { id: "boardTag", name: "tag" }, {}, {})}</fieldset> <fieldset class="flex flex-col gap-2">${validate_component(Label, "Label").$$render($$result, { for: "boardTag" }, {}, {
            default: () => {
              return `Tag Values`;
            }
          })} ${validate_component(Input, "Input").$$render($$result, { id: "boardTag", name: "tagValues" }, {}, {})} <p class="text-sm text-muted-foreground" data-svelte-h="svelte-17g6gtu">Separate values with comma. Like: &quot;apple,pear,banana&quot;</p></fieldset> ${validate_component(Button, "Button").$$render($$result, { type: "submit" }, {}, {
            default: () => {
              return `Create Board`;
            }
          })}</form>`;
